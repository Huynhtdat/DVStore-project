      ...
      <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('user.home') }}" class="nav-link">Home Website</a>
          </li>
        </ul>
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ route('admin.home') }}" class="brand-link">
          ...
          <span class="brand-text font-weight-light">
            {{-- kiểm tra người dùng đăng nhập có role_id = 1 thì là Super Admin còn bằng 2 là Admin (nhân viên) --}}
            {{ (Auth::guard('admin')->user()->role_id == 1) ? 'Manager Admin' : 'Manager Staff'}}
          </span>
        </a>
        ...
        <div class="sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
              <a href="{{ route('admin.profile_change-profile') }}" class="d-block">{{ Auth::guard('admin')->user()->name }} </a>
            </div>
          </div>
          ...
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item">
                @php
                    $isRouteUser = request()->is('admin/admins*');
                @endphp
                <a href="{{ route('admin.admins_index') }}" class="nav-link {{ ($isRouteUser) ? 'active' : '' }}">
